 ...
 -->
  <header class="vide" data-vide-bg="video/video-bg">
    <div class="container vide_content">
      ...
      <form id="bookingForm" class="booking-form" action="Thank.html" method="post" > <!-- هبعت لفورم بي اتش بي تبعت لدتا بيز ولوبعتت تظهر صفحه ثانك لو مبعتتش تطلع كلمهايرور -->
        <h3 style="text-align: center; color: black; size: 20px;">Complaint Form</h3>
        <br>
        <div class="tmInput" style="color: black; text-align: left;">
        Student Name:
        <input type="text" placeholder="Full student name" name="xe1">
        <br>
        <br>
        Level:
        ...
        <br>
        Student ID:
        <input type="text" placeholder="University Student ID" name="xe6">
        <br>
        <br>
        Specialization:
       <input type="text" name="xeq6">
         <br>
         <br>
       ...
       <textarea name="mw" placeholder="Enter Text Here...."></textarea>
        ...
        <br>
        <br>
        Doctor The recipient's decision:
        <textarea name="mw" placeholder="Enter Text Here...."></textarea>
        <br>
        <br>
        Addressed to:
        <select id="car" name="MS1"> 
                ...
                <option value="NO">الارشيف</option> 
         </select>
        <br>
        <br>
        Vice leader The recipient's decision:
        <textarea name="mw" placeholder="Enter Text Here...."></textarea>
      
        
        <input style="margin-left: 65px;" class="btn" type="Submit" value="SEND COMPLAINT!" name="iu">
       <p style="color:#000000; text-align: center;">If you would like return home page<a href="file:///E:/gRADUATION/percenrage/Admin/Academic%20Guide/Home.html" style="color:blue;"> click here</a></p>
      </form>
      </div>
