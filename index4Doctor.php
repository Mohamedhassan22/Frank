    ...
    <div class="container vide_content">
      ...
      <form id="bookingForm" class="booking-form" action="Thank.php" method="post" > <!-- هبعت لفورم بي اتش بي تبعت لدتا بيز ولوبعتت تظهر صفحه ثانك لو مبعتتش تطلع كلمهايرور -->
       ...
       <textarea name="mw" placeholder="Enter Text Here...."></textarea>
        ...
        <br>
        Resend to:
        <select id="car" name="MS1D"> 
                <option value="MOD">وكيل الكلية لشئون التعليم والطلاب</option> 
                <option value="NOD">مرشد القسم المحدد بالاعلي</option>
                <option value="MKJHD">ارشيف</option>
         </select>
        <input style="margin-left: 65px;" class="btn" type="Submit" value="RESEND COMPLAINT!" name="ipomu">
       <p style="color:#000000; text-align: center;">If you would like return home page<a href="http://localhost:8080/percenrage/project/HomeDoc.php" style="color:blue;"> click here</a></p>
      </form>
      </div>
